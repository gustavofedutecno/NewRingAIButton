...
// Prototipos de funciones auxiliares en mic.c
bool mic_is_i2s_installed();
void mic_uninstall_i2s();
...
void spp_callback(esp_spp_cb_event_t event, esp_spp_cb_param_t *param)
{
    ...
    case ESP_SPP_CONG_EVT:
        // Caso de congestión en modo micrófono
    ...
    case ESP_SPP_CLOSE_EVT:
        ...
        ESP_LOGI(SPP_TAG, "Desconexión del cliente");
        spp_ready = false;
        client_handle = 0;
